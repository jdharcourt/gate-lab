...
- Draw circuit: add copies of A–D input blocks and standard gate symbols from the left, click a source dot and then a gate input or Q, and drag blocks to arrange them. Repeated blocks with the same letter share one truth-table input. Once the circuit is complete, generate a blank truth table and check your outputs.
